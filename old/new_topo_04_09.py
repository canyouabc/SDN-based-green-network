...
from send_arp import send_arp_all, MyCLI  # ← 記得 import
...
def load_link_bw(filename='data/link_bw.txt'):
    ...
    print(f"[INFO] Loaded {len(link_bw_map)} link bandwidth entries from {filename}")
    return link_bw_map
...
def topology():
    ...
    for i in range(len(cores)):
        for j in range(i+1, len(cores)):
            ...
            net.addLink(cores[i], cores[j], bw=bw, burst='1m')
    ...
    for idx, d in enumerate([d1, d2, d3, d4, d5, d6, d7, d8]):
        ...
        net.addLink(core1, d, bw=bw1, burst='1m')
        net.addLink(core2, d, bw=bw2, burst='1m')
    ...
    for idx, d in enumerate([d9, d10, d11, d12, d13, d14]):
        ...
        net.addLink(core3, d, bw=bw3, burst='1m')
        net.addLink(core4, d, bw=bw4, burst='1m')
    ...
    for src_d1, src_d2, wan_list, wan_dpids in wan_dist_pairs:
        ...
        for d_switch, src_dpid in zip(d_list, [src_d1, src_d2]):
            for w, w_dpid in zip(wan_list, wan_dpids):
                ...
                net.addLink(d_switch, w, bw=bw, burst='1m')
    ...
    for src_d1, src_d2, access_list, access_dpids in dist_access_pairs:
        for a, a_dpid in zip(access_list, access_dpids):
            ...
            net.addLink(dist_map[src_d1], a, bw=bw1, burst='1m')
            net.addLink(dist_map[src_d2], a, bw=bw2, burst='1m')
    ...
    for idx, a in enumerate([a17, a18, a19, a20, a21]):
        ...
        net.addLink(d13, a, bw=bw_d13, burst='1m')
        net.addLink(d14, a, bw=bw_d14, burst='1m')
